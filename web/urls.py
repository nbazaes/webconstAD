...
urlpatterns = [
    ...
    path('api/media/<path:file_path>/', views.api_public_media, name='api-public-media'),
    ...
    path('api/pagos/flow/confirmacion/', csrf_exempt(views.api_flow_confirmation), name='api-flow-confirmation'),
