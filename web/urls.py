...
urlpatterns = [
    ...
    path('api/colecciones/', views.api_colecciones, name='api-colecciones'),
    path('api/colecciones/<slug:slug>/productos/', views.api_coleccion_productos, name='api-coleccion-productos'),
