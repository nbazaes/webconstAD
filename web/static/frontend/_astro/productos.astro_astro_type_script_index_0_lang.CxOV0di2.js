        ...
        <form class="auth-form" data-edit-form>
          ...
          <div data-edit-coleccion-wrap ${e.es_gratuito?"hidden":""}>
            ...
            <select name="coleccion_id">
              ...
              ${$.map(t=>`<option value="${t.id}" ${e.coleccion_id===t.id?"selected":""}>${t.nombre}</option>`).join("")}
            </select>
          </div>
