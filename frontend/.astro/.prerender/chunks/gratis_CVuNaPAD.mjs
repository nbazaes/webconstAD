import { c as createComponent, $ as $$BaseLayout } from './BaseLayout_ByQ1pRV9.mjs';
import 'piccolore';
import { r as renderComponent, a as renderTemplate, m as maybeRenderHead, b as addAttribute } from './prerender_CcAMggrq.mjs';
...
const $$Gratis = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Gratis - Constant Archivos Digitales", "page": "gratis", "data-astro-cid-abedn53u": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="content" data-astro-cid-abedn53u> <section class="products-hero text-block" data-astro-cid-abedn53u> <h2 data-astro-cid-abedn53u>GRATIS</h2> <p class="lead" data-astro-cid-abedn53u>Recursos gratuitos para <em data-astro-cid-abedn53u>imprimir</em> o <em data-astro-cid-abedn53u>dibujar</em> digitalmente.</p> </section> ${categoriasRender.length > 0 ? renderTemplate`<section class="products-grid" data-astro-cid-abedn53u> ${categoriasRender.map((cat) => renderTemplate`<div class="product" data-astro-cid-abedn53u> <a${addAttribute(`/gratis/${cat.slug}/`, "href")} class="product-link"${addAttribute(cat.descripcion || "", "title")} data-astro-cid-abedn53u> ${cat.imagen ? renderTemplate`<img${addAttribute(cat.imagen, "src")}${addAttribute(cat.descripcion || cat.nombre, "alt")} data-astro-cid-abedn53u>` : renderTemplate`<div class="card" data-astro-cid-abedn53u> <img src="/static/web/assets/g345.png" alt="Sin imagen" data-astro-cid-abedn53u> </div>`} </a> <a${addAttribute(`/gratis/${cat.slug}/`, "href")} class="product-title"${addAttribute(cat.descripcion || "", "title")} data-astro-cid-abedn53u> ${cat.nombre} </a> </div>`)} </section>` : renderTemplate`<section class="products-hero text-block" data-astro-cid-abedn53u> <p data-astro-cid-abedn53u>Próximamente recursos gratuitos.</p> <ul data-astro-cid-abedn53u> <li data-astro-cid-abedn53u>Plantillas de práctica</li> <li data-astro-cid-abedn53u>Mini colecciones de muestra</li> <li data-astro-cid-abedn53u>Recursos estacionales</li> </ul> </section>`} </main> ` })}`;
